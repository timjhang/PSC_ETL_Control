...
public class ETL_L_CALENDAR extends Load {
	
	public ETL_L_CALENDAR() {
		
	}

	public ETL_L_CALENDAR(ETL_Bean_LogData logData, String fedServer, String runTable) {
	...
	public void load_File() {
		try {
			trans_to_CALENDAR_LOAD(this.logData, this.fedServer, this.runTable);
		} catch (Exception e) {
			e.printStackTrace();
		} 
	}
