...
public class ETL_L_LOAN_DETAIL extends Load {

	public ETL_L_LOAN_DETAIL() {
		
	}

	public ETL_L_LOAN_DETAIL(ETL_Bean_LogData logData, String fedServer, String runTable) {
	...
	public void load_File() {
		try {
			trans_to_LOAN_DETAIL_LOAD(this.logData, this.fedServer, this.runTable);
		} catch (Exception e) {
			e.printStackTrace();
		} 
	}
	...
	public void trans_to_LOAN_DETAIL_LOAD(ETL_Bean_LogData logData, String fedServer, String runTable) {
		...
		System.out.println("#######Load - ETL_L_LOAN_DETAIL - Start"); 
		...
		System.out.println("#######Load - ETL_L_LOAN_DETAIL - End"); 
