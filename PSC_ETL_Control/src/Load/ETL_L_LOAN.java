...
public class ETL_L_LOAN extends Load {

	public ETL_L_LOAN() {
		
	}

	public ETL_L_LOAN(ETL_Bean_LogData logData, String fedServer, String runTable) {
	...
	public void load_File() {
		try {
			trans_to_LOAN_LOAD(this.logData, this.fedServer, this.runTable);
		} catch (Exception e) {
			e.printStackTrace();
		} 
	}
