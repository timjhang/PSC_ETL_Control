...
public class ETL_L_TRANSACTION extends Load {

	public ETL_L_TRANSACTION() {
		
	}

	public ETL_L_TRANSACTION(ETL_Bean_LogData logData, String fedServer, String runTable) {
	...
	public void load_File() {
		try {
			trans_to_TRANSACTION_LOAD(this.logData, this.fedServer, this.runTable);
		} catch (Exception e) {
			e.printStackTrace();
		} 
	}
	
	// 觸發DB2載入Procedure, 資料載入TRANSACTION_LOAD_TEMP  
	public void trans_to_TRANSACTION_LOAD(ETL_Bean_LogData logData, String fedServer, String runTable) {
		
		System.out.println("#######Load - ETL_L_TRANSACTION - Start"); 
		...
		System.out.println("#######Load - ETL_L_TRANSACTION - End"); 
