...
public class ETL_DM_QUESTIONS extends Migration {
	public ETL_DM_QUESTIONS() {
	}

	public ETL_DM_QUESTIONS(ETL_Bean_DM_LogData logData) {
		super(logData);
	}

	@Override
	public void migration_File() {
		System.out.println("#######Migration - ETL_DM_QUESTIONS - Start");
		Connection con = null;
		CallableStatement cstmt = null;
		try {
			String sql = "{call " + ETL_Profile.db2TableSchema + ".Migration.ETL_DM_QUESTIONS(?,?,?)}";
		...
		System.out.println("#######Migration - ETL_DM_QUESTIONS - End");
	}
}