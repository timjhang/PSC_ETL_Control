...
public class ETL_DM_ALERT_LOAN extends Migration {
	public ETL_DM_ALERT_LOAN() {
	}

	public ETL_DM_ALERT_LOAN(ETL_Bean_DM_LogData logData) {
		super(logData);
	}

	@Override
	public void migration_File() {
		System.out.println("#######Migration - ETL_DM_ALERT_LOAN - Start");
		Connection con = null;
		CallableStatement cstmt = null;
		try {
			String sql = "{call " + ETL_Profile.db2TableSchema + ".Migration.ETL_DM_ALERT_LOAN(?,?,?)}";
		...
		System.out.println("#######Migration - ETL_DM_ALERT_LOAN - End");
	}
}