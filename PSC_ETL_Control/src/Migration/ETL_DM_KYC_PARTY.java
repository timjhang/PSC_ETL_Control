...
public class ETL_DM_KYC_PARTY extends Migration {
	public ETL_DM_KYC_PARTY() {
	}

	public ETL_DM_KYC_PARTY(ETL_Bean_DM_LogData logData) {
		super(logData);
	}

	@Override
	public void migration_File() {
		System.out.println("#######Migration - ETL_DM_KYC_PARTY - Start");
		Connection con = null;
		CallableStatement cstmt = null;
		try {
			String sql = "{call " + ETL_Profile.db2TableSchema + ".Migration.ETL_DM_KYC_PARTY(?,?,?)}";
		...
		System.out.println("#######Migration - ETL_DM_KYC_PARTY - End");
	}
}