...
public class ETL_DM_USERS extends Migration {
	public ETL_DM_USERS() {
	}

	public ETL_DM_USERS(ETL_Bean_DM_LogData logData) {
		super(logData);
	}

	@Override
	public void migration_File() {
		System.out.println("#######Migration - ETL_DM_USERS - Start");
		Connection con = null;
		CallableStatement cstmt = null;
		try {
			String sql = "{call " + ETL_Profile.db2TableSchema + ".Migration.ETL_DM_USERS(?,?,?)}";
		...
		System.out.println("#######Migration - ETL_DM_USERS - End");
	}
}