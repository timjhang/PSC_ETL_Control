...
public class ETL_DM_KYC_ACCOUNT extends Migration {
	public ETL_DM_KYC_ACCOUNT() {
	}

	public ETL_DM_KYC_ACCOUNT(ETL_Bean_DM_LogData logData) {
		super(logData);
	}

	@Override
	public void migration_File() {
		System.out.println("#######Migration - ETL_DM_KYC_ACCOUNT - Start");
		Connection con = null;
		CallableStatement cstmt = null;
		try {
			String sql = "{call " + ETL_Profile.db2TableSchema + ".Migration.ETL_DM_KYC_ACCOUNT(?,?,?)}";
		...
		System.out.println("#######Migration - ETL_DM_KYC_ACCOUNT - End");
	}
}