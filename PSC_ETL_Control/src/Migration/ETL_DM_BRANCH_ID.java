...
public class ETL_DM_BRANCH_ID extends Migration {
	public ETL_DM_BRANCH_ID() {
	}

	public ETL_DM_BRANCH_ID(ETL_Bean_DM_LogData logData) {
		super(logData);
	}

	@Override
	public void migration_File() {
		System.out.println("#######Migration - ETL_DM_BRANCH_ID - Start");
		Connection con = null;
		CallableStatement cstmt = null;
		try {
			String sql = "{call " + ETL_Profile.db2TableSchema + ".Migration.ETL_DM_BRANCH_ID(?,?,?)}";
		...
		System.out.println("#######Migration - ETL_DM_BRANCH_ID - End");
	}
}