...
public class ETL_DM_ALERTS extends Migration {
	public ETL_DM_ALERTS() {
	}

	public ETL_DM_ALERTS(ETL_Bean_DM_LogData logData) {
		super(logData);
	}

	@Override
	public void migration_File() {
		System.out.println("#######Migration - ETL_DM_ALERTS - Start");
		Connection con = null;
		CallableStatement cstmt = null;
		try {
			String sql = "{call " + ETL_Profile.db2TableSchema + ".Migration.ETL_DM_ALERTS(?,?,?)}";
		...
		System.out.println("#######Migration - ETL_DM_ALERTS - End");
	}
}