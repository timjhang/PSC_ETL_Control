...
public class ETL_DM_TRANSFER_TR extends Migration {
	public ETL_DM_TRANSFER_TR() {
	}

	public ETL_DM_TRANSFER_TR(ETL_Bean_DM_LogData logData) {
		super(logData);
	}

	@Override
	public void migration_File() {
		System.out.println("#######Migration - ETL_DM_TRANSFER_TR - Start");
		Connection con = null;
		CallableStatement cstmt = null;
		try {
			String sql = "{call " + ETL_Profile.db2TableSchema + ".Migration.ETL_DM_TRANSFER_TR(?,?,?)}";
		...
		System.out.println("#######Migration - ETL_DM_TRANSFER_TR - End");
	}
}