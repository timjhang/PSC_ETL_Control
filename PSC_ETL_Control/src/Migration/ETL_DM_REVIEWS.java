...
public class ETL_DM_REVIEWS extends Migration {
	public ETL_DM_REVIEWS() {
	}

	public ETL_DM_REVIEWS(ETL_Bean_DM_LogData logData) {
		super(logData);
	}

	@Override
	public void migration_File() {
		System.out.println("#######Migration - ETL_DM_REVIEWS - Start");
		Connection con = null;
		CallableStatement cstmt = null;
		try {
			String sql = "{call " + ETL_Profile.db2TableSchema + ".Migration.ETL_DM_REVIEWS(?,?,?)}";
		...
		System.out.println("#######Migration - ETL_DM_REVIEWS - End");
	}
}