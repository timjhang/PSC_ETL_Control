...
public class ETL_DM_ALERT_ADDRESS extends Migration {
	public ETL_DM_ALERT_ADDRESS() {
	}

	public ETL_DM_ALERT_ADDRESS(ETL_Bean_DM_LogData logData) {
		super(logData);
	}

	@Override
	public void migration_File() {
		System.out.println("#######Migration - ETL_DM_ALERT_ADDRESS - Start");
		Connection con = null;
		CallableStatement cstmt = null;
		try {
			String sql = "{call " + ETL_Profile.db2TableSchema + ".Migration.ETL_DM_ALERT_ADDRESS(?,?,?)}";
