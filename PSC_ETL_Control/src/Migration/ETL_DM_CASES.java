...
public class ETL_DM_CASES extends Migration {
	public ETL_DM_CASES() {
	}

	public ETL_DM_CASES(ETL_Bean_DM_LogData logData) {
		super(logData);
	}

	@Override
	public void migration_File() {
		System.out.println("#######Migration - ETL_DM_CASES - Start");
		Connection con = null;
		CallableStatement cstmt = null;
		try {
			String sql = "{call " + ETL_Profile.db2TableSchema + ".Migration.ETL_DM_CASES(?,?,?)}";
		...
		System.out.println("#######Migration - ETL_DM_CASES - End");
	}
}