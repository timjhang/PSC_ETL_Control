...
public class ETL_DM_KYCS extends Migration {
	public ETL_DM_KYCS() {
	}

	public ETL_DM_KYCS(ETL_Bean_DM_LogData logData) {
		super(logData);
	}

	@Override
	public void migration_File() {
		System.out.println("#######Migration - ETL_DM_KYCS - Start");
		Connection con = null;
		CallableStatement cstmt = null;
		try {
			String sql = "{call " + ETL_Profile.db2TableSchema + ".Migration.ETL_DM_KYCS(?,?,?)}";
		...
		System.out.println("#######Migration - ETL_DM_KYCS - End");
	}
}