...
public class ETL_DM_TR_MAPPING extends Migration {
	public ETL_DM_TR_MAPPING() {
	}

	public ETL_DM_TR_MAPPING(ETL_Bean_DM_LogData logData) {
		super(logData);
	}

	@Override
	public void migration_File() {
		System.out.println("#######Migration - ETL_DM_TR_MAPPING - Start");
		Connection con = null;
		CallableStatement cstmt = null;
		try {
			String sql = "{call " + ETL_Profile.db2TableSchema + ".Migration.ETL_DM_TR_MAPPING(?,?,?)}";
		...
		System.out.println("#######Migration - ETL_DM_TR_MAPPING - End");
	}
}