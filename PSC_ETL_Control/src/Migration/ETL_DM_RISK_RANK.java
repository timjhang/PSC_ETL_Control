...
public class ETL_DM_RISK_RANK extends Migration {
	public ETL_DM_RISK_RANK() {
	}

	public ETL_DM_RISK_RANK(ETL_Bean_DM_LogData logData) {
		super(logData);
	}

	@Override
	public void migration_File() {
		System.out.println("#######Migration - ETL_DM_RISK_RANK - Start");
		Connection con = null;
		CallableStatement cstmt = null;
		try {
			String sql = "{call " + ETL_Profile.db2TableSchema + ".Migration.ETL_DM_RISK_RANK(?,?,?)}";
		...
		System.out.println("#######Migration - ETL_DM_RISK_RANK - End");
	}
}