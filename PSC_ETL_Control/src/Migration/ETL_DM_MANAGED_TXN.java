...
public class ETL_DM_MANAGED_TXN extends Migration {
	public ETL_DM_MANAGED_TXN() {
	}

	public ETL_DM_MANAGED_TXN(ETL_Bean_DM_LogData logData) {
		super(logData);
	}

	@Override
	public void migration_File() {
		System.out.println("#######Migration - ETL_DM_MANAGED_TXN - Start");
		Connection con = null;
		CallableStatement cstmt = null;
		try {
			String sql = "{call " + ETL_Profile.db2TableSchema + ".Migration.ETL_DM_MANAGED_TXN(?,?,?)}";
		...
		System.out.println("#######Migration - ETL_DM_MANAGED_TXN - End");
	}
}